...
#Consumables itens list

low_healing_potion = consumables('Low Healing Potion', 'Potion with low healing properties. Heals 4 HP.', 2)
...
# class healing_itens(consumables):

#     def __init__(self, name, description, value, qtd=1):
#         super().__init__(name, description, value, qtd)
#         self.healing_power = 